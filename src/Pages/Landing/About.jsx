...
const About = () => {
  ...
  return (
    <div className="full  mt-[80px] xl:mt-[140px]">
      <div className="xl:flex-row flex-col section gap-[60px] xl:gap-[120px]">
        <div className="w-full flex justify-center items-center relative h-auto  min-h-[350px] xl:min-h-[600px]">
          <img
            src="/logo.png"
